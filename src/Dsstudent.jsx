...
function Dsstudent() {
  ...
  const fetchStudents = () => {
    axios
      .get('https://teacherbackend-page.onrender.com/dsstudent')
  ...
  const handleDeleteAll = () => {
    if (window.confirm('Are you sure you want to delete ALL students?')) {
      axios
        .delete('https://teacherbackend-page.onrender.com/delete-allds')
        .then(() => setStudents([]))
        .catch(err => console.error(err));
    }
  };
    ...
    <div className='body'>
      ...
      <div className="student-container">
        <div className="student-card">
          <Link to="/createds" className="btn-add">Add +</Link>
